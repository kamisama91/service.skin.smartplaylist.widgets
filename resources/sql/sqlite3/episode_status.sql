select ep.idepisode as id, fi.dateadded, fi.lastplayed, ifnull(fi.playcount,0) as playcount, cast(ifnull(bo.timeinseconds,0) as INT) as resumetime, ep.c09 as totaltime
from episode ep
